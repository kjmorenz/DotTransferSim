...
def write(filepath, filedir, fullfilename, antibunch, diffuse, pulsed, endsigcts, numlines, maxlines, endtime,
            ...
            NA, darkcounts, sensitivity, nligands, deadtime, afterpulse, timeres, timestep, channels, seq, mL1, probfiss, anni, ac, setavgems, printall):
...
##    file.write("Pulse bins = " +str(pulsebins) + " \n")
    ...
    file.write("\n")
    file.write("Definitive parameters:")
    lvars = locals()
    for i in lvars:
        file.write(i + " : " + str(lvars[i]) + "\n")
    file.close()
